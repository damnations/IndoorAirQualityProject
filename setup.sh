...
sudo sed -1 "s/sudo apt-get install -y python3-pip/sudo apt install -y python3-pip git chromium-browser unclutter" $HOME/raspi-blinka.py
sudo sed -i "s/apt-get/apt/g" $HOME/raspi-blinka.py
